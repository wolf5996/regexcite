...
-   What I will do now is go through [R packages (2e)] to learn the basics of package development in general and for R specifically.
...
-   `load_all()`: loads all of the functions defined in the package without actually adding them to the global env. Good way of testing the package as it matures.
  ...
  [Section 3.3.1]: https://r-pkgs.org/structure.html#sec-rbuildignore
  [Chapter 9]: https://r-pkgs.org/description.html
  [Section 4.2]: https://r-pkgs.org/workflow101.html#sec-workflow101-rstudio-projects
...
-   The export directive in `NAMESPACE` is what makes `strsplit1()` available to a user after attaching regexcite via [`library(regexcite)`]. Just as it is entirely possible to author `.Rd` files “by hand”, you can manage `NAMESPACE` explicitly yourself. But we choose to delegate this to devtools (and roxygen2).
  ...
  [`library(regexcite)`]: https://rdrr.io/r/base/library.html
...
![][1]
  ...
  [1]: images/clipboard-4036790326.png
...
![][2]
  ...
  [2]: images/clipboard-3399855533.png
